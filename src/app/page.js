  ...
  const projects = [
    {
      ...
      description:
        'Modern React Native application featuring API integration, navigation, nested ScrollViews, and responsive UI design.',
      ...
      live:
        'https://react-native-student-management-app.vercel.app/',
...

    {
      ...
      description:
        'A real-world blood donation platform with donor management and emergency requests.',
...

    {
      ...
      description:
        'Future smart evacuation system focused on emergency response and safety.',
        ...
        <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-8 max-w-xl mb-10">
              ...
              Building premium mobile and web applications
...
>
  ...
  <div className="absolute w-[250px] md:w-[350px] h-[250px] md:h-[350px] rounded-full bg-blue-500 blur-[120px] animate-pulse">
  </div>
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
      ...
      />
          <p className="text-gray-400 text-lg leading-10 max-w-4xl">
            ...
            I am a Software Engineering student passionate
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex gap-4 flex-wrap">
                      ...
                      <a
                        ...
                        target="_blank"
                        className="flex items-center gap-2 px-5 py-3 rounded-full border border-gray-700 hover:border-blue-500 hover:text-blue-400 transition-all duration-300"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        className="flex items-center gap-2 px-5 py-3 rounded-full bg-blue-600 hover:bg-blue-700 transition-all duration-300"
                      >
